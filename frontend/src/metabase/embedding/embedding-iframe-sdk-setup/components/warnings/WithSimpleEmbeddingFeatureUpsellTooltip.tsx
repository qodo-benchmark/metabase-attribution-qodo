  ...
  return (
    <TooltipWarning
      ...
      warning={
        ...
        >
          {t`Upgrade to get access to embeds with single sign-on, drill through, advanced theming, the SDK for React, and more. You cannot access these features without upgrading.`}
        </UpsellCard>
      }
      disabled={disabled}
    >
